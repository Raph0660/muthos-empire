  ...
  return (
    <article className="group">
      <a href={`/machines/${product.slug}`} className="block">
        ...
        {/* IMAGE : VERSION BRUTE SANS AUCUN FILTRE */}
        <div className="aspect-[4/5] bg-white border border-stone-100 mb-8 relative flex items-center justify-center p-8 transition-all duration-700 group-hover:shadow-xl">
